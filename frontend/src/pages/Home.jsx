...
const Home = () => {
  ...
  return (
    <div className="min-h-screen pt-24 sm:pt-28 pb-20 px-4 relative w-full overflow-x-hidden bg-slate-50 font-sans selection:bg-green-100 selection:text-green-700">
      ...
      {/* Floating Elements (Hidden on mobile to save space/performance) */}
      ...
      <div className="max-w-6xl mx-auto relative z-10 flex flex-col items-center">
        ...
        <div className="text-center mb-10 sm:mb-16 max-w-4xl px-2">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight mb-4 sm:mb-6 leading-tight">
          ...
          <div className="bg-white rounded-[1.5rem] sm:rounded-[2rem] px-4 sm:px-6 py-8 sm:py-12 md:px-16 border border-slate-50 shadow-sm relative overflow-hidden">
            ...
            <div className="grid md:grid-cols-2 gap-10 sm:gap-16 md:divide-x md:divide-slate-100 items-start">
              ...
              <div className="flex flex-col items-center text-center space-y-4 sm:space-y-6 group">
                ...
                <div className="w-full pt-2"><ImageUploader onIngredientsDetected={(detected) => setIngredients([...new Set(detected)])} /></div>
              </div>
              ...
              <div className="flex flex-col items-center text-center space-y-4 sm:space-y-6 md:pl-16 group">
                ...
                <div className="w-full pt-2"><IngredientInput /></div>
              </div>
            </div>
            ...
            <div className="mt-12 sm:mt-16 flex justify-center">
              ...
              >
                <span className="relative z-10 flex items-center gap-3">Find Matching Recipes <span className="group-hover:translate-x-1 transition-transform">➜</span></span>
                {ingredients.length > 0 && <span className="absolute -top-2 -right-2 bg-white text-green-600 text-xs font-extrabold w-6 h-6 flex items-center justify-center rounded-full border-2 border-green-50 shadow-md animate-bounce z-20">{ingredients.length}</span>}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full px-2 sm:px-4">
          {[
            ...
            <div key={i} className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.05)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
